      ...
      <Stack spacing={2} sx={{ width: '100%' }}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} lg={4}>
              <FormControl fullWidth error={errors.address && true}>
                <InputLabel id='Org-registration-province-select-label'>
                  Province
                </InputLabel>
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      {provice.map((provice, index) => (
                        <MenuItem value={provice} key={index}>
                          {provice}
                        </MenuItem>
                      ))}
                    </Select>
            ...
            <Grid item xs={6} lg={4}>
              <FormControl fullWidth error={errors.address && true}>
                <InputLabel id='Org-registration-city-select-label'>
                  City
                </InputLabel>
                <Controller
                  name='address.city'
            ...
            <Grid item xs={12}>
              <UploadArea
                text={'Click here to Business Registration'}
                handleFile={(data) => {
                  setFile(data);
                }}
              />
